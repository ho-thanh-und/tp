...
`MainApp`](https://github.com/se-edu/addressbook-level3/tree/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
...
**Use Case: UC06 - Adding interview schedule to an applicant**
...
2. Should be able to hold up to 1000 candidates for hire without a noticeable sluggishness in performance for typical
   usage.
