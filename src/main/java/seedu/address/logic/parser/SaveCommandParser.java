...
public class SaveCommandParser implements Parser<SaveCommand> {
    ...
    public SaveCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_FILE, PREFIX_SAVE_ALL);
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_FILE, PREFIX_SAVE_ALL);
        ...
        return new SaveCommand(path, saveAll);
    }
}
