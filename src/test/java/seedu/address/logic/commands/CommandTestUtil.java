...
public class CommandTestUtil {
    ...
    public static final String INVALID_JOBTITLE_DESC = " " + PREFIX_JOBTITLE + "U1/UX D3s1ng3r"; // integers not
    // allowed in job titles
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withJobTitle(VALID_JOBTITLE_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withJobTitle(VALID_JOBTITLE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    }
