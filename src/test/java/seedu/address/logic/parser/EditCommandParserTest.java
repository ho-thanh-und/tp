...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_JOB_ROLE_DESC, JobRole.MESSAGE_NEW_CONSTRAINTS); // invalid JD
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY
                        + VALID_PHONE_AMY + VALID_JOB_ROLE_AMY + VALID_LABEL_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + JOB_ROLE_DESC_AMY + LABEL_DESC_AMY
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // job role
        userInput = targetIndex.getOneBased() + JOB_ROLE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withJobRole(VALID_JOB_ROLE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC + INVALID_JOB_ROLE_DESC
                + INVALID_LABEL_DESC;
        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE,
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                ...
                + INVALID_JOB_ROLE_DESC + INVALID_LABEL_DESC;
